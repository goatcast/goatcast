          ...
          {profile && (
            <div className="mt-6 pt-6 border-t border-gray-700">
              ...
              <div className="bg-gray-900 rounded p-4">
                <p className="text-blue-400"><strong>Username:</strong> {profile.username}</p>
                <p className="text-blue-400"><strong>Display Name:</strong> {profile.displayName}</p>
                <p className="text-blue-400"><strong>FID:</strong> {profile.fid}</p>
              </div>
            </div>
          )}
        </div>
